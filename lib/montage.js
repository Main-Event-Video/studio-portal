...
export function buildMontageSource({ photos, style = 'hollywood', title, subtitle, watermarkUrl, width = 1920, height = 1080 }) {
  const S = STYLES[style] || STYLES.hollywood;
  const n = photos.length;
  const total = montageDuration(n, style);
