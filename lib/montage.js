...
export const STYLES = {
  hollywood: {
    ...
    transitions: ['fade'],
    zoom: ['100%', '112%'],
    // Cast-free dissolve: photos hold-and-fade on two alternating tracks so each
    // dissolve blends image→image only, never through the green backdrop (which
    // used to tint transitions green and survive keying). Margins stay green.
    holdFade: true,
  },
  timeless: {
