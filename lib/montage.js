...
function framedBoxSource({ S, seq, title, subtitle, watermarkUrl, includeCards, width: W, height: H, background, assetBase, perPhoto = null, atmosphere = true, frameW = null, frameColor = null }) {
...
function buildMontageSourceInner({ photos, items, style = 'hollywood', title, subtitle, watermarkUrl, photoSeconds = null, totalSeconds = null, includeCards = true, width = 1920, height = 1080, background = null, greenBookends = true, assetBase = null, mpTransition = null, mpStagger = null, mpHold = null, mpSpeed = null, duoPalette = null, duoTreatment: duoTreat = null, glassLight = true, glassRefl = true, atmosphere = true, frameW = null, frameColor = null }) {
  ...
  if (S.framedBox) return finish(framedBoxSource({ S, seq, title, subtitle, watermarkUrl, includeCards, width, height, background, assetBase, perPhoto, atmosphere: atmosphere !== false, frameW, frameColor }));
...
export function buildMontageSource(opts = {}) {
  return applyKeyColor(buildMontageSourceInner(opts), opts.keyColor);
}
