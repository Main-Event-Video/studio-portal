  ...
  if (neonOn && neonPct > 0) {
    ...
    for (const e of source.elements) {
      ...
      if (neonMul >= 1.5) {
        ...
        halves.forEach(([a0, a1], hi) => {
          e.elements.push(standing(a0, a1, hi, px(0.020), Math.round(neonPct * 0.20)));
          e.elements.push(standing(a0, a1, hi, px(0.009), Math.round(neonPct * 0.42)));
          e.elements.push(standing(a0, a1, hi, px(0.0035), Math.round(neonPct * 0.9)));
        });
      }
      ...
      if (neonMul >= 1.5) {
        ...
        for (let bi = 0; bi < nBars; bi++) {
          ...
          e.elements.push(bar(px(0.012), Math.round(op * 0.3)));
          e.elements.push(bar(px(0.004), op));
        }
      }
