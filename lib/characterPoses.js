...
export const CAPTURE_INTRO = [
  ...
  'Plain wall, good light — the more boring the background, the more you pop.',
  'Keep it simple and the same all the way through: solid colors, one outfit, one hairstyle. You’re one character, not twelve!',
  'Lose the hats and sunglasses, and keep hair off your face.',
  'Hold the phone upright at eye level and fill the outline on screen.',
  'For full-body shots, back up so you fit head to toe.',
];
